...
void GuiManager::connectWidgets() {
  ...
  QObject::connect(this, &GuiManager::serverSearchResponse, _widgetDocsBrowser, &DocsBrowser::searchResponse);
...
void GuiManager::connectClientToServer() {
  ...
  QObject::connect(this, &GuiManager::searchQuery, _manager.get(), &MessageManager::searchQuery);
...
void GuiManager::connectServerToClient() {
  ...
  QObject::connect(_manager.get(), &MessageManager::searchResponse, this, &GuiManager::serverSearchResponse);
